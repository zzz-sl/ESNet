...
from esnet.models.comformer import iComformerConfig, eComformerConfig
...
FEATURESET_SIZE = {"basic": 11, "atomic_number": 1, "cfid": 438, "cgcnn": 70}
...
class TrainingConfig(BaseSettings):
    ...
    id_tag: Literal["jid", "id", "material_id","_oqmd_entry_id"] = "jid"
    ...
    def set_input_size(cls, values):
        ...
        # ]
        values["model"].atom_input_features = 70
        values["model"].kge_input_features = 128
        # values["model"].funsion_feature = 512
        return values
